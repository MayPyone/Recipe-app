...
class ReciipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reciipe" do
    assert_difference("Reciipe.count") do
      post reciipes_url, params: { reciipe: { cooking_time: @reciipe.cooking_time, description: @reciipe.description, name: @reciipe.name, preparation_time: @reciipe.preparation_time, public: @reciipe.public, user_id: @reciipe.user_id } }
    end
  ...
  test "should update reciipe" do
    patch reciipe_url(@reciipe), params: { reciipe: { cooking_time: @reciipe.cooking_time, description: @reciipe.description, name: @reciipe.name, preparation_time: @reciipe.preparation_time, public: @reciipe.public, user_id: @reciipe.user_id } }
