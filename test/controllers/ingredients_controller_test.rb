  ...
  test 'should create ingredient' do
    assert_difference('Ingredient.count') do
      post ingredients_url,
           params: { ingredient: { measurement_unit: @ingredient.measurement_unit, name: @ingredient.name,
                                   quantity: @ingredient.quantity, reciipe_id: @ingredient.reciipe_id, value: @ingredient.value } }
    end
