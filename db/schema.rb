...
ActiveRecord::Schema[7.1].define(version: 2023_12_07_233628) do
  ...
  create_table "foods_reciipes", id: false, force: :cascade do |t|
  ...
  create_table "reciipes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_reciipes_on_user_id"
  end
